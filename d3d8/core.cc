...
// include the Direct3D8 headers
#include "d3d8.h"

/*
	This is the function to create an instance of a Direct3D8 interface.
*/
LPDIRECT3D8 Direct3DCreate8(int pSDK)
{
	// we ignore the SDK version and creaty a D3D8 interface
